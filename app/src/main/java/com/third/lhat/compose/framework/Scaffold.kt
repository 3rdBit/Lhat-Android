package com.third.lhat.compose.framework
...
/*
 * This file is modified by the owner of the project for the optimization.
 */
 ...
 * @param floatingActionButton com.third.lhat.compose.Main action button of your screen. Consider using
    ...
    SubcomposeLayout { constraints ->
        ...
        layout(layoutWidth, layoutHeight) {
            ...
            val fabOffsetFromBottom = fabPlacement?.let {
                ...
                48.dp.roundToPx() + it.height + FabSpacing.roundToPx()
            }
